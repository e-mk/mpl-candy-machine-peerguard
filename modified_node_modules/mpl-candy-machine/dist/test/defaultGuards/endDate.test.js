...
(0, ava_1.default)('it allows minting before the end date', async (t) => {
    ...
    const { publicKey: candyMachine } = await (0, _setup_1.createV2)(umi, {
        ...
        guards: {
            endDate: (0, umi_1.some)({ date: (0, _setup_1.tomorrow)() }),
        },
    });
    // When we mint it.
...
(0, ava_1.default)('it forbids minting after the end date', async (t) => {
    ...
    const { publicKey: candyMachine } = await (0, _setup_1.createV2)(umi, {
        ...
        configLines: [{ name: 'Degen #1', uri: 'https://example.com/degen/1' }],
        guards: {
            endDate: (0, umi_1.some)({ date: (0, _setup_1.yesterday)() }),
        },
    });
...
(0, ava_1.default)('it charges a bot tax when trying to mint after the end date', async (t) => {
    ...
    await (0, _setup_1.assertBotTax)(t, umi, mint, signature, /AfterEndDate/);
});
//# sourceMappingURL=endDate.test.js.map