...
(0, ava_1.default)('it allows minting after the start date', async (t) => {
    ...
    const { publicKey: candyMachine } = await (0, _setup_1.createV2)(umi, {
        ...
        guards: {
            startDate: (0, umi_1.some)({ date: (0, _setup_1.yesterday)() }),
        },
    });
...
(0, ava_1.default)('it forbids minting before the start date', async (t) => {
    ...
    const { publicKey: candyMachine } = await (0, _setup_1.createV2)(umi, {
        ...
        configLines: [{ name: 'Degen #1', uri: 'https://example.com/degen/1' }],
        guards: {
            startDate: (0, umi_1.some)({ date: (0, _setup_1.tomorrow)() }),
        },
    });
...
(0, ava_1.default)('it charges a bot tax when trying to mint before the start date', async (t) => {
    ...
    await (0, _setup_1.assertBotTax)(t, umi, mint, signature, /MintNotLive/);
});
//# sourceMappingURL=startDate.test.js.map