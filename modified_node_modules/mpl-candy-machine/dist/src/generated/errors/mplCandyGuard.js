...
exports.getMplCandyGuardErrorFromName = exports.getMplCandyGuardErrorFromCode = exports.CgTransactionAlreadyExistsError = exports.CgNoPreviousInstructionError = exports.CgSignatureAuthorityMismatchError = exports.CgInvalidAccountVersionError = exports.CgInstructionBuilderFailedError = void 0;
...
class CgSignatureAuthorityMismatchError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('Signature authority mismatch', program, cause);
        this.name = 'SignatureAuthorityMismatch';
        this.code = 0x17a4; // 6052
    }
}
exports.CgSignatureAuthorityMismatchError = CgSignatureAuthorityMismatchError;
codeToErrorMap.set(0x17a4, CgSignatureAuthorityMismatchError);
nameToErrorMap.set('SignatureAuthorityMismatch', CgSignatureAuthorityMismatchError);
/** NoPreviousInstruction: Couldn't Load Previous Instruction */
class CgNoPreviousInstructionError extends umi_1.ProgramError {
    constructor(program, cause) {
        super("Couldn't Load Previous Instruction", program, cause);
        this.name = 'NoPreviousInstruction';
        this.code = 0x17a5; // 6053
    }
}
exports.CgNoPreviousInstructionError = CgNoPreviousInstructionError;
...
class CgTransactionAlreadyExistsError extends umi_1.ProgramError {
    constructor(program, cause) {
        super('The provided transaction id has already been used to mint a NFT', program, cause);
        this.name = 'TransactionAlreadyExists';
        this.code = 0x17a6; // 6054
    }
}
exports.CgTransactionAlreadyExistsError = CgTransactionAlreadyExistsError;
