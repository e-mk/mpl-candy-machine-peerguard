...
export declare class CgSignatureAuthorityMismatchError extends ProgramError {
    readonly name: string;
    readonly code: number;
    constructor(program: Program, cause?: Error);
}
/** NoPreviousInstruction: Couldn't Load Previous Instruction */
export declare class CgNoPreviousInstructionError extends ProgramError {
    readonly name: string;
    readonly code: number;
    constructor(program: Program, cause?: Error);
}
/** TransactionAlreadyExists: The provided transaction id has already been used to mint a NFT */
export declare class CgTransactionAlreadyExistsError extends ProgramError {
    readonly name: string;
    readonly code: number;
    constructor(program: Program, cause?: Error);
}
